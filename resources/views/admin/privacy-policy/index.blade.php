            ...
            <div class="card my-3">
                <div class="heading-title p-2 my-2">
                    <span class="my-3 heading"><i class="fas fa-home"></i>
                        <a href="{{ route('dashboard') }}">Dashboard</a> > Privacy Policy
                    </span>
                </div>
                <div class="card-body table-card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <textarea id="description" class="form-control form-control-sm @error('description') is-invalid @enderror"
                                        name="description" placeholder="Enter Description" rows="5">{{ old('description', $privacy->description) }}</textarea>
                                    @error('description')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                    ...
                    @else
                        <div class="alert alert-warning">No Privacy Policy content found. Please create a new entry.</div>
                    @endif
                </div>
            </div>
        </div>
